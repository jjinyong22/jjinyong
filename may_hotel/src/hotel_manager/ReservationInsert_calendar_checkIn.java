...
public class ReservationInsert_calendar_checkIn extends JFrame implements WindowListener, ActionListener, ItemListener{
	...
	public ReservationInsert_calendar_checkIn(Reservation_insert res_insert){
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		res_insert.texts[1].setText(res_date);
		dispose();//������Ʈ�� �̺�Ʈ�� ���� ������ ����(�޸𸮿��� ������)
