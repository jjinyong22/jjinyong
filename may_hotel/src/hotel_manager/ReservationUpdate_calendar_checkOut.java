...
public class ReservationUpdate_calendar_checkOut extends JFrame implements WindowListener, ActionListener, ItemListener{
	...
	public ReservationUpdate_calendar_checkOut(Reservation_update res_update){
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		res_update.texts[3].setText(res_date);
		dispose();
	}
	public void init(){
		select();
