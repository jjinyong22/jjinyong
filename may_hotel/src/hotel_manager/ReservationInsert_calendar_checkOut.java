...
public class ReservationInsert_calendar_checkOut extends JFrame implements WindowListener, ActionListener, ItemListener{
	...
	public ReservationInsert_calendar_checkOut(Reservation_insert res_insert){
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		res_insert.texts[2].setText(res_date);
		dispose();
	}
	public void init(){
		select();
