...
public class ReservationRoad_calendar_checkIn extends JFrame implements WindowListener, ActionListener, ItemListener{
	...
	public ReservationRoad_calendar_checkIn(Reservation_road_table res_road){
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		res_road.texts[1].setText(res_date);
		dispose();//������Ʈ�� �̺�Ʈ�� ���� ������ ����(�޸𸮿��� ������)
