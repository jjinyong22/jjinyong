...
public class ReservationRoad_calendar_checkOut extends JFrame implements WindowListener, ActionListener, ItemListener{
	...
	String res_date;
	Reservation_road_table res_road;
	public ReservationRoad_calendar_checkOut(Reservation_road_table res_road){
		this.res_road = res_road; 
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		res_road.texts[2].setText(res_date);
		dispose();//������Ʈ�� �̺�Ʈ�� ���� ������ ����(�޸𸮿��� ������)
//		this.setDefaultCloseOperation(DISPOSE_ON_CLOSE); --> ����� ����.(�������� x��ư�� ���ؼ� ���� �̺�Ʈ�� ó���� �� ���.(����� �Ȱ���)
	}
	public void init(){
		select();
		calendar();
