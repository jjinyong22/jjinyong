...
public class ReservationUpdate_calendar_checkIn extends JFrame implements WindowListener, ActionListener, ItemListener{
	...
	public ReservationUpdate_calendar_checkIn(Reservation_update res_update){
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		res_update.texts[2].setText(res_date);
		dispose();//������Ʈ�� �̺�Ʈ�� ���� ������ ����(�޸𸮿��� ������)
