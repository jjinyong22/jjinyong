...
public class Yoya_can_calendar_checkin extends JFrame implements WindowListener, ActionListener, ItemListener{
	...
	String res_date;
	Yoya_can yo_can;
	public Yoya_can_calendar_checkin(Yoya_can yo_can){
		this.yo_can = yo_can;
