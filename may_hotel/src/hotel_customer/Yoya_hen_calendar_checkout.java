...
public class Yoya_hen_calendar_checkout extends JFrame implements WindowListener, ActionListener, ItemListener{
	...
	String res_date;
	Yoya_henncou yo_hen;
	public Yoya_hen_calendar_checkout(Yoya_henncou yo_hen){
		this.yo_hen = yo_hen; 
