...
public class Yoya_hen_calendar_checkin extends JFrame implements WindowListener, ActionListener, ItemListener{
	...
	String res_date;
	Yoya_henncou yo_hen;
	public Yoya_hen_calendar_checkin(Yoya_henncou yo_hen){
		this.yo_hen = yo_hen;
